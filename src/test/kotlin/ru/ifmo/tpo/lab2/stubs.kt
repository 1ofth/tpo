...
val logExprTestData = mapOf(0.1 to 2.298177825, 1.15 to -0.0003198911944, 2.283 to -0.06408018395,
    8.664 to -0.5898652502, 15.1 to -0.01482795675, 15.187 to -0.000005706433244, 15.3 to 0.01949345212)

val logExprStub = mock(LogExpr::class.java).apply {
    logExprTestData.forEach { (x, y) -> `when`(this.calc(x)).thenReturn(y) }
}

val trigExprTestData = mapOf(-5.6 to 9.935287128, -5.2 to 5.204563109, -5.107 to 4.915328871,
    -5.0 to 5.311095369, -4.1 to -1.181150345, -4.001 to -0.007715186586, -3.9 to 3.821331351,
    -2.2 to -4.859889701, -2.038 to -3.874125114, -1.8 to -5.504093972, -1.1 to 1.058410083,
    -0.995 to 0.8232738581, -0.8 to 3.116791055)
...
val cotTestData = mapOf(-5.6 to 1.228586832, -5.2 to 0.5303233938, -5.107 to 0.4164553151, -5.0 to 0.2958129155,
    ...
    -0.8 to -0.9712146007, 0.1 to 9.966644423, 1.15 to 0.4475280222,
...
val cscTestData = mapOf(-5.6 to 1.584116663, -5.2 to 1.131920007, -5.107 to 1.083252062, -5.0 to 1.042835213,
    ...
    -0.8 to -1.394007819, 0.1 to 10.01668613, 1.15 to 1.095573517,
...
val secTestData = mapOf(-5.6 to 1.289381119, -5.2 to 2.134395767, -5.107 to 2.601124353, -5.0 to 3.525320086,
    -4.1 to -1.739663085, -4.001 to -1.53165981, -3.9 to -1.377538917, -2.2 to -1.699232118,
    -2.038 to -2.220291054, -1.8 to -4.401367872, -1.1 to 2.204604389, -0.995 to 1.836537545,
    -0.8 to 1.4353242, 0.1 to 1.005020918, 1.15 to 2.44805568, 2.283 to -1.530213994,
    8.664 to -1.380643689, 15.1 to -1.218304151, 15.187 to -1.152950203, 15.3 to -1.089406763)
...
val lnTestData = mapOf(0.1 to -2.302585093, 1.0 to 0.0, 1.15 to 0.1397619424, 2.283 to 0.8254903675,
    ...
    3.0 to 1.09861228867, 5.0 to 1.60943791243, 10.0 to 2.30258509299)
